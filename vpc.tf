...
# use data source to get a list of all avalablility zones in region
# the [0] is called indexing and when it get a list of all AZ it will select the first availabulity zone in this region
...
# it will get a list of all the AZ and select the second AZ
